...
(function() {
  ...
  function updateVideoSource() {
    ...
    const mobileVideoSource = 'assets/cover2.mp4'; // Path to the mobile video

    if (window.innerWidth <= 1200) { // Adjust the width threshold as needed
      sourceElement.src = mobileVideoSource;
    } else {
      sourceElement.src = 'assets/cover.mp4'; // Default video source
    }
